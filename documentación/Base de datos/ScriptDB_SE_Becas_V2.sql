/*
    ...
    Version:    2.0
    Date:       15/07/2020 06:20:00 a.m.
    Author:     Huerta Medina Andy Mariano
    Email:      utlandymariano@gmail.com
    Comments:   Segunda version de la DB_SE_Becas, Eliminnación de la tala UnidadesAcademica_Carreras,
                relación agregada entre las tabla UnidadesAcademicas, Carreras, Especialidades;
                relacion agregada entre la tabla Cuatimestres a Alumnos_Proyectos,
                renombramiento de columnas basado en el DiagramaER_3.
*/
