/*
    ...
    Version:    3.0
    Date:       24/07/2020 01:20:00 a.m.
    Author:     Huerta Medina Andy Mariano
    Email:      utlandymariano@gmail.com
    Comments:   Tercera version de la DB_SE_Becas, cambio de nombre a las columnas
				CarerrasPreferentes a CarrerasPreferentes de la tabla Proyectos y
                EstatusServiciosocial a EstatusServicioBecario de la tabla Alumnos_Proyectos.
*/
