/*
    ...
    Version:    3.0
    Date:       05/08/2020 09:55:00 p.m.
    Author:     Huerta Medina Andy Mariano
    Email:      utlandymariano@gmail.com
    Comments:   Tercera version de los StoredProceduresDB_SE_Becas,
				Modificacion a los procedimientos almacenados de Empleados
                Alumnos y Proyectos.
*/
...
BEGIN
    ...
    INSERT INTO Empleados (NomEmpleado, NumEmpleado, Puesto_Cargo, Departamento,
                           CorreoElectronico, Telefono, Ext, Estado, IdUsuario)
                VALUES (v_nombre, v_numero, v_puesto, v_departamento,
                        v_correo, v_telefono, v_ext, v_estado, v_idUsuario);
...
BEGIN
    ...
    INSERT INTO Alumnos(NomAlumno, Matricula, IdUnidadAcademica, IdCarrera,
                        IdEspecialidad, Turno, Grupo, IdBeca, HorasServicioBecario, Estado)
                VALUES(v_nombre, v_matricula, v_unidadAcademica, v_carrera,
                       v_especialidad, v_turno, v_grupo, v_beca, v_horasServicio, v_estado);
END 
$$
DELIMITER ;
...
BEGIN
    ...
    INSERT INTO Proyectos(NomProyecto, IdEmpleado, IdArea, Departamento,
                          ...
                          CarrerasPreferentes, Observaciones, Estado, Estatus)
                   VALUES(v_nombre, v_idEmpleado, v_idArea, v_departamento,
                          ...
                          v_carreras, v_observaciones, v_estado, v_estatus);
END 
$$
DELIMITER ;
